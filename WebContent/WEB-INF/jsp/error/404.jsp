	...
	<jsp:include page="../main/layout.jsp" flush="false"></jsp:include>
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <p class="lead">페이지를 찾을 수 없습니다.
            <a href="javascript:history.back()">이전페이지</a>
            	또는 
            <a href="Index">메인페이지로</a>돌아가주세요</p>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright Â© how far have you been 2018 made by Kim Keon Wook, Kim Tae Hyung, Kim Ju Yong</span>
            </div>
          </div>
        </footer>
